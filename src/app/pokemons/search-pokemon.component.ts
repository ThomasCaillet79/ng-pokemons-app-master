...
export class PokemonSearchComponent implements OnInit {
	...
	private searchTerms = new Subject<string>();   // Subject hérite de la classe Observable
	pokemons$: Observable<Pokemon[]>;  // variable$, convention des variables de type Observable
